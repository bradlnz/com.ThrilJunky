...
//                    
//                    self.output.startRecording(toOutputFileURL: outputURL, recordingDelegate: self)
//                    
...
//    }
// 
//    func closeCamera(_ sender: UIButton!){
//        self.cameraView = nil
...
//        
//        let videoTrack = composition.addMutableTrack(withMediaType: AVMediaTypeVideo, preferredTrackID: CMPersistentTrackID())
//        let trackAudio = composition.addMutableTrack(withMediaType: AVMediaTypeAudio, preferredTrackID: CMPersistentTrackID())
//
...
//                      
//                        
//                          let uploadUserPhotoTask = storageImgRef.child("images/" + userPhotoFile).put(userImageData, metadata: imgMetadata)
//                        
...
//                        let uploadTask = storageImgRef.child("images/" + imageFile).put(imageData!, metadata: imgMetadata);
//                        
//                        // Listen for state changes, errors, and completion of the upload.
...
//                            
//                            // Upload file and metadata to the object 'images/mountains.jpg'
//                            let uploadTask = storageRef.child("videos/" + videoFile).put(data!, metadata: metadata)
//                            
//                            // Listen for state changes, errors, and completion of the upload.
//                            uploadTask.observe(.pause) { snapshot in
//                                // Upload paused
...
//                                guard let errorCode = FIRStorageErrorCode(rawValue: storageError as! Int) else { return }
//                                switch errorCode {
