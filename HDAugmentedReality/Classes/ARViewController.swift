...
open class ARViewController: UIViewController, ARTrackingManagerDelegate
{
    ...
    func addCloseButton()
    {
        ...
        {
           self.closeButtonImage = UIImage(named: "close")
        }
        ...
        closeButton.frame = CGRect(x: self.view.bounds.size.width - 45, y: self.view.frame.height - 50, width: 40,height: 40)
    ...
    func addDebugUi()
    {
        ...
        debugLabel.frame = CGRect(x: 30, y: self.view.bounds.size.height - 50, width: self.view.bounds.size.width - 10, height: 45)
        ...
        debugMapButton.backgroundColor = UIColor.white.withAlphaComponent(1)
